...
import id.ac.ui.cs.mobileprogramming.rdpradiptagitayas.learntktpl.model.services.api.ApiServiceImpl
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupViewModel() {
        mainViewModel = ViewModelProviders.of(
            this,
            ApplicationViewModelFactory(ApiHelper(ApiServiceImpl()))
